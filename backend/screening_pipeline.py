"""Screening pipeline orchestration using the shared AI modules."""
...
def run_screening_pipeline(screening_id, presented_face_bytes=None):
    ...
    try:
        ...
        _insert("ocr_results", {
            ...
            "processing_status": ocr.get("status", "completed"),
        })
        ...
        face = run_face_verification(document_bytes, presented_face_bytes, mime_type, document_type)
